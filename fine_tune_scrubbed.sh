...
#SBATCH -J fine-tune-scrubbed
#SBATCH -c 16
#SBATCH --mem=32GB
#SBATCH --output="/h/dadsetan/fine_tune_scrubbed.log"
...
CHECKPOINT_PATH="/checkpoint/dadsetan/fine_tune_scrubbed_$1"
...
python ./examples/fine_tune.py --config_path ./configs/fine-tune/echr-gpt2-small-scrubbed.yml --output_dir $CHECKPOINT_PATH &
wait
